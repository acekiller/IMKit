...
internal class JCEmoticonPageView: UICollectionViewCell, UIGestureRecognizerDelegate {
    ...
    private lazy var _backspaceButton: UIButton = UIButton(type: .custom)
...
//        _backspaceButton.setTitle("⌫", for: .normal)
        _backspaceButton.setImage(ThemeManager.instance.loadImage("emoji_back_icon", .default), for: .normal)
