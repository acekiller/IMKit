...
open class JCEmoticonInputView: UIView {
    ...
    lazy var _tabbarLayout: UICollectionViewFlowLayout = UICollectionViewFlowLayout()
    lazy var _tabbar: UICollectionView = UICollectionView(frame: .zero, collectionViewLayout: self._tabbarLayout)
