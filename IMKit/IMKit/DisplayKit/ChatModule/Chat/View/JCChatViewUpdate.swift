...
internal class JCChatViewUpdate: NSObject {
    ...
    internal init(newData: JCChatViewData, oldData: JCChatViewData, updateItems: [JCChatViewUpdateChangeItem]) {
    ...
    // MARK: compute
    internal func _computeItemUpdates(_ newData: JCChatViewData, _ oldData: JCChatViewData, _ updateItems: [JCChatViewUpdateChangeItem]) -> [JCChatViewUpdateChange] {
        guard !updateItems.isEmpty else {
            return []
        }
        var allInserts: [(Int, JCMessageType)] = []
        var allUpdates: [(Int, JCMessageType)] = []
        var allRemoves: [(Int)] = []
        var allMoves: [(Int, Int)] = []
...
//        var im = allMoves.startIndex
    ...
    private func _diff<T: JCMessageType>(_ src: [T], _ dest: [T]) -> [JCChatViewUpdateChange] {
        ...
        var results: [JCChatViewUpdateChange] = []
    ...
    internal let updateItems: [JCChatViewUpdateChangeItem]
    internal var updateChanges: [JCChatViewUpdateChange]?
