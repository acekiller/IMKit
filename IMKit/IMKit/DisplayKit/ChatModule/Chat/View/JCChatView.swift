...
@objc open class JCChatView: UIView {
    ...
    func insert(contentsOf newMessages: [JCMessageType], at index: Int) {
        _batchBegin()
    ...
    func remove(contentOf indexs: [Int]) {
        _batchBegin()
    ...
    func append(contentsOf newMessages: [JCMessageType]) {
    ...
    fileprivate lazy var _batchItems: [JCChatViewUpdateChangeItem] = []
    fileprivate lazy var _batchRequiredCount: Int = 0

    private func _commonInit() {

        backgroundColor = UIColor(netHex: 0xF5F7FC)
...
extension JCChatView: UICollectionViewDataSource, JCChatViewLayoutDelegate {
    ...
    open func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAvatarOf options: JCMessageOptions) -> CGSize {
        // 78 * 78
        return .init(width: 36.0, height: 36.0)
    }
    open func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemCardOf options: JCMessageOptions) -> CGSize {
        return .init(width: 0, height: 18)
    }

    public func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemTipsOf options: JCMessageOptions) -> CGSize {
        return .init(width: 100, height: 21)
    }

    open func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForItemOf options: JCMessageOptions) -> UIEdgeInsets {
        ...
        case .bubble:
            ...
            // |        | |   |
            // +----12--+-+---+
            return .init(top: 10, left: 8, bottom: 10, right: 8)
...
//            return .init(top: 10, left: 10, bottom: 10, right: 10)
    ...
    open func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForItemCardOf options: JCMessageOptions) -> UIEdgeInsets {
        return .init(top: 0, left: 8, bottom: 2, right: 8)
    }
    open func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForItemAvatarOf options: JCMessageOptions) -> UIEdgeInsets {
        return .init(top: 0, left: 2, bottom: 2, right: 2)
    }
    open func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForItemBubbleOf options: JCMessageOptions) -> UIEdgeInsets {
        if options.style == .custom {
            return options.bubbleInset
        } else {
            return .init(top: 0, left: 8, bottom: 0, right: 0)
        }
    }
    open func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForItemContentOf options: JCMessageOptions) -> UIEdgeInsets {
        switch options.style {
        case .bubble:
...
//            return .init(top: 8 + 2, left: 10 + 2, bottom: 8 + 2, right: 10 + 2)
            return .init(top: 4, left: 5, bottom: 4, right: 5)
