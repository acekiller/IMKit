...
public class JCGroupSettingCell: UITableViewCell {
    ...
    private lazy var flowLayout: UICollectionViewFlowLayout = {
        ...
        flowLayout.itemSize = CGSize(width: (frame.width / 5), height: 80)
...
//        let showMore = isMyGroup ? count > 13 : count > 14
        ...
        addConstraint(_JCLayoutConstraintMake(collectionView, .left, .equal, self, .left, 10))
        addConstraint(_JCLayoutConstraintMake(collectionView, .right, .equal, self, .right, -10))
