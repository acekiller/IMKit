...
class FriendsBusinessCardViewController: IMBaseViewController {
    ...
    fileprivate lazy var tableView: UITableView = {
        ...
        tableView.frame = CGRect(x: 0, y: 31 + 64, width: self.view.frame.width, height: self.view.frame.height - 31 - 64)
        return tableView
    }()
    ...
    fileprivate lazy var tipsView: UIView = {
        let view = UIView(frame: CGRect(x: 0, y: 64 + 31 + 5, width: self.view.frame.width, height: self.view.frame.height - 31 - 64 - 5))
    ...
    private func _init() {
        ...
        searchView.frame = CGRect(x: 0, y: 0, width: toolView.frame.width, height: 31)
