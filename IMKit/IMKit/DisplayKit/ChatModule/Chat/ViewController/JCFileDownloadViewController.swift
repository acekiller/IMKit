...
class JCFileDownloadViewController: IMBaseViewController {
    ...
    @objc func _downloadFile() {
        ...
        MBProgressHUDJChat.showMessage(message: "下载中", toView: view)
        content?.fileData { (data, _, error) in
            ...
            if error == nil {
                ...
                MBProgressHUDJChat.show(text: "下载失败", view: self.view)
            }
        }
    }
