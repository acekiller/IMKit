...
class JCRemindListViewController: IMBaseViewController {

    typealias handleFinish = (_ user: JMSGUser?, _ isAtll: Bool, _ length: Int) -> Void
    ...
    fileprivate lazy var searchView: UISearchBar = {
        ...
        searchView.frame = CGRect(x: 0, y: 0, width: self.view.frame.width, height: 31)
