...
final public class ThemeManager: NSObject {
    ...
    public lazy var send_nor =  ThemeManager.instance.loadImage("chat_img_dialog_blue", .default)?.resizableImage(withCapInsets: UIEdgeInsets.init(top: 15, left: 15, bottom: 15, right: 15))
    public lazy var send_press = ThemeManager.instance.loadImage("chat_img_dialog_blue", .default)?.resizableImage(withCapInsets: UIEdgeInsets.init(top: 15, left: 15, bottom: 15, right: 15))

    public lazy var recive_nor = ThemeManager.instance.loadImage("chat_img_dialog_white", .default)?.resizableImage(withCapInsets: UIEdgeInsets.init(top: 15, left: 15, bottom: 15, right: 15))
    public lazy var recive_press = ThemeManager.instance.loadIMKitImage(imageName: "chat_img_dialog_white")?.resizableImage(withCapInsets: UIEdgeInsets.init(top: 15, left: 15, bottom: 15, right: 15))
    ...
    public func loadIMKitImage(imageName: String) -> UIImage? {
        var image = UIImage(named: imageName, in: Bundle(for: ThemeManager.self), compatibleWith: nil)
        if image == nil {
            image = UIImage(named: imageName, in: Bundle.main, compatibleWith: nil)
        }
        return image
    }
