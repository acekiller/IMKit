...
extension Date {
    ...
    static public func dateWithDaysFromNow(_ days: Int) -> Date {
        return Date().dateByAddingDays(days)
    }

    static public func dateWithDaysBeforeNow(_ days: Int) -> Date {
        return Date().dateBySubtractingDays(days)
    }

    static public func dateTomorrow() -> Date {
        return Date.dateWithDaysFromNow(1)
    }

    static public func dateYesterday() -> Date {
    ...
    public func conversationDate() -> String {
