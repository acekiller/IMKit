...
public extension String {
    static public func getTodayYesterdayString(_ theDate: Date) -> String {
    ...
    static public func getPastDateString(_ theDate: Date) -> String {
        let formatter = DateFormatter()
        let locale: Locale = Locale(identifier: "zh")
        formatter.locale = locale
    ...
    static public func getFriendlyDateString(_ timeInterval: TimeInterval, forConversation isShort: Bool) -> String {
    ...
    static public func conversationIdWithConversation(_ conversation: JMSGConversation) -> String {
        var conversationId = ""
...
extension String {
    static public func errorAlert(_ error: NSError) -> String {
...
public extension String {
    ...
    public var isExpectations: Bool {
    ...
    static public func getRecorderPath() -> String {
