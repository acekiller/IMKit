...
protocol SAIInputAccessoryViewDelegate: class {
...
public class SAIInputAccessoryView: UIView {
    ...
    public var textField: SAIInputTextField {
        return _textField
    }
...
//        _textField.layer.borderColor = UIColor.gray.cgColor
    ...
    fileprivate lazy var _textField: SAIInputTextField = {
        let field = SAIInputTextField()
        var containerInset = field.textContainerInset
        containerInset.left = 12.0
        containerInset.right = 12.0
        field.textContainerInset = containerInset
        field.attributedPlaceholder = NSAttributedString(string: "发送消息…", attributes: [.font: UIFont(name: "PingFangSC-Regular", size: 14.0), .foregroundColor: UIColor.init(netHex: 0x999999)])
        return field
    }()
...
///
private func _diff<T: Equatable>(_ src: [T], _ dest: [T]) -> [(Int, Int, Int)] {
